function payrix-rds-pci --description="Connect to prodpci psql rds"
    set -f aws_profile payrix-prodpci
    set -f jump_host_name prod-jobs-dev
    set -f db_host "prod-payrix.cluster-cvzqqve8hxw0.us-east-1.rds.amazonaws.com"
    set -f remote_port 5432
    set -f local_port 5432
    set -f pg_user payrixroot
    set -f pg_db payrix
    set -f op_vault jpurcmohy6ayoy56xv2sf4jete
    set -f op_secret pzef32fcgrrrsqdphkdp2b3i5y
