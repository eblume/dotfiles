...
function obj:init()
  ...
  self.launcher:bind("", "return", function()
    self:switch("/Applications/Wezterm.app")
  end)
  ...
  self.launcher:bind("", "B", function()
    self:switch("Safari.app")
  end)
  ...
  self.launcher:bind("", "S", function()
    self:switch("/Applications/Slack.app")
  end)
  self.launcher:bind("", "O", function()
    self:switch("/Applications/Obsidian.app")
  end)
  self.launcher:bind("", "T", function()
    self:switch("/Applications/Todoist.app")
  end)
end
